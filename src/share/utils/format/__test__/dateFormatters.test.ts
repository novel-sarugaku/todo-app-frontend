...
import { formatDate, formatMonthly, formatDateLocal } from '@/share/utils/format/dateFormatters'
...
describe('formatDateLocal', () => {
  describe('正常系', () => {
    it('日付を「YYYY年M月D日」に整形できる', () => {
      expect(formatDateLocal(new Date('2025-09-01T00:00:00Z'))).toBe('2025-09-01')
    })
  })
})
